...
Rails.application.routes.draw do
  ...
  match '/inspections/download_estimator_inspection_pdf' => 'inspections#download_estimator_inspection_pdf', :as => 'download_estimator_inspection_pdf', :via => [:get, :options], :defaults => {:format => 'pdf'}
